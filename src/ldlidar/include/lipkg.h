...
public:
	...
	void SetRangeThreshold(const float range_threshold) { range_threshold_ = range_threshold;};
	void SetTimestampOffset(const double stamp_offset) { stamp_offset_ = stamp_offset; }
private:
	uint16_t mTimestamp;
	double mSpeed;
