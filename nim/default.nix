...
let
  ...
  self = stdenv.mkDerivation (finalAttrs: {
    ...
    src = fetchurl {
      url = "https://github.com/nim-lang/nightlies/releases/download/2023-11-30-devel-beeacc86ff8b0fb6e1507a4a9462c93d8a0eb989/nim-2.1.1-linux_x64.tar.xz";
      hash = "sha256-uXdwWy3ilUPtsEBLHSVodadIENL/WPwak8u/akmwrAc=";
    };
...
in
self // { pkgs = callPackage "${nixpkgs}/pkgs/top-level/nim-packages.nix" { nim = self; }; }
